 ...
 * - if the patient's blood pressure is 'low' it evaluates the 1st child.
 * - if the patient's blood pressure is 'mid' it evaluates the 2nd child.
 * - if the patient's blood pressure is 'high' it evaluates the 3rd child.
 */
public class BloodPressure extends GPNode {
	@Override
	...
	public void eval(EvolutionState evolutionState, int i, GPData gpData, ADFStack adfStack, GPIndividual gpIndividual, Problem problem) {
		...
		switch (postOperativeProblem.patient.bloodPressure) {
			case low:
